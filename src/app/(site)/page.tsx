...
import { ArrowRight, Brain, Database, Lightbulb, Zap, Shield, TrendingUp, Cloud, Cpu, Globe, Wand } from "lucide-react"
...
const features = [
  {
    ...
    description: "Creating intuitive, engaging UI/UX designs that prioritize user needs, enhancing usability and customer satisfaction.",
    icon: Brain,
    gradient: "from-primary/20 to-primary/10",
  },
  {
    title: "End-to-End Software Engineering",
    description: "Delivering complete full-stack software solutions, from front-end interfaces to back-end systems, ensuring seamless performance and scalability.",
    icon: Database,
    gradient: "from-secondary/20 to-secondary/10",
  },
  {
    title: "Mobile & Web Solutions",
    description: "Designing custom mobile apps for iOS, Android, and cross-platform, alongside responsive, secure, and scalable modern web applications.",
    icon: Lightbulb,
    gradient: "from-accent/20 to-accent/10",
  },
  {
    title: "AI & Machine Learning Integration",
    description: "Harnessing data to develop intelligent systems, predictive models, and automation tools that drive business success.",
    icon: Brain,
    gradient: "from-primary/20 to-primary/10",
  },
  {
    title: "Generative AI Solutions",
    description: "Empowering organizations with AI-driven tools for content creation, process automation, and creative solutions that redefine industries.",
    icon: Database,
    gradient: "from-secondary/20 to-secondary/10",
  },
  {
    title: "Cloud-Native Architecture & Scalability",
    description: "Architecting cloud-native environments using AWS, Azure, and GCP for flexible, secure, and scalable solutions optimized for performance.",
    icon: Lightbulb,
    gradient: "from-accent/20 to-accent/10",
  },
]
        ...
        <div className="relative container mx-auto px-6 py-24 lg:py-32">
          <div className="max-w-6xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-gray-800/80 text-gray-200 px-4 py-2 rounded-full text-sm font-medium mb-8 animate-[slideUp_0.8s_ease-out] border border-gray-700">
              <Zap className="w-4 h-4 animate-pulse text-[#5cd85a]" />
              Powering the Future of AI
            </div>
 
            <h1 className="text-4xl md:text-6xl lg:text-6xl font-bold mb-12 text-balance text-white">
              Transform Your Business with
              <span className="block bg-gradient-to-r from-white to-white/80 bg-clip-text text-transparent mt-6">
        ...
        <section className="py-24 bg-background">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-4 text-balance">Our Core Expertise</h2>
              ...
              {features.map((feature, index) => {
                ...
                return (
                  <ScrollReveal key={index} delay={index * 200}>
                    <Card className="group hover:shadow-xl transition-all duration-500 border border-border/50 bg-card hover:scale-105 hover:-translate-y-2 h-full flex flex-col">
                      ...
                      <CardContent className="flex flex-col flex-grow">
                        ...
                        <Button
                          variant="ghost"
                          className="mt-4 p-0 h-auto text-primary hover:text-primary/80 group/btn self-start"
                        >
                          Learn more
      ...
      <ScrollReveal>
        <section className="py-24 bg-background">
          <div className="container mx-auto px-6 text-center max-w-4xl">
            <div className="inline-flex items-center gap-2 bg-gray-100 text-gray-700 px-4 py-2 rounded-full text-sm font-medium mb-8 border border-gray-200">
              <TrendingUp className="w-4 h-4" />
              Ready to Scale?
            </div>
 
            <h2 className="text-3xl md:text-5xl font-bold mb-6 text-balance text-gray-900">
              Ready to Transform Your Business?
            </h2>
            <p className="text-xl mb-12 text-gray-600 max-w-2xl mx-auto text-pretty">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                asChild
                size="lg"
                className="bg-gray-900 text-white hover:bg-gray-800 hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl"
              >
                <Link href="/contact" className="flex items-center gap-2">
                  Start Your Journey
                  <ArrowRight className="w-4 h-4" />
              ...
              {/* <Button
                ...
                variant="outline"
                size="lg"
                className="border-gray-300 text-gray-700 hover:bg-gray-50 hover:scale-105 transition-all duration-300"
              >
